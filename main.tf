...
resource "aws_s3_bucket_object" "image" {
  bucket = "terraform-aw-team"
  key    = "image.jpg"
  source = "/root/home_pipeline/image.jpg"
  depends_on = [
...
resource "aws_s3_bucket_object" "videos" {
  bucket = "terraform-aw-team"
  key    = "earth.gif"
  source = "/root/home_pipeline/earth.gif"
  depends_on = [
    aws_s3_bucket.terraform-aw-team
  ]
}
...
resource "aws_s3_bucket_object" "sdefaults" {
  ...
  source = "/root/home_pipeline/index-default.jpg"
  depends_on = [
    aws_s3_bucket.terraform-aw-team
  ]
}
resource "aws_s3_bucket_object" "index" {
  ...
  source = "/root/home_pipeline/index-default.html"
  depends_on = [
    aws_s3_bucket.terraform-aw-team
  ]
}
resource "aws_s3_bucket_object" "default_images" {
  bucket = "terraform-aw-team"
  key    = "image.html"
  source = "/root/home_pipeline/image.html"
  depends_on = [
    aws_s3_bucket.terraform-aw-team
  ]
}
resource "aws_s3_bucket_object" "default_gif" {
  bucket = "terraform-aw-team"
  key    = "earth.html"
  source = "/root/home_pipeline/earth.html"
  depends_on = [
    aws_s3_bucket.terraform-aw-team
  ]
}
